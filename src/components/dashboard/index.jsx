			...
			<section className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
				...
				<div className="lg:col-span-7 bg-surface-container-low rounded-xl p-8 relative overflow-hidden">
					...
					<div className="flex items-baseline gap-4">
						<h2 className="font-headline text-5xl font-extrabold tracking-tight text-on-surface">$142,804.52</h2>
				...
				<div className="lg:col-span-8 space-y-6">
					...
					<div className="grid grid-cols-1 gap-3">
						...
						<div
							...
							<div className="flex items-center justify-between md:justify-end gap-12 mt-4 md:mt-0">
								<div className="text-right">
									<div className="text-lg font-bold font-headline text-on-surface">4.200 HBAR</div>
						...
						<div
							...
							<div className="flex items-center justify-between md:justify-end gap-12 mt-4 md:mt-0">
								<div className="text-right">
									<div className="text-lg font-bold font-headline text-on-surface">8.112 HBAR</div>
									<div className="text-[10px] text-on-surface-variant uppercase tracking-widest">≈
										$17,765.00</div>
								</div>
								<div className="flex gap-2">
						...
						<div
							...
							<div className="flex items-center justify-between md:justify-end gap-12 mt-4 md:mt-0">
								<div className="text-right">
									<div className="text-lg font-bold font-headline text-on-surface">2.510 HBAR</div>
									<div className="text-[10px] text-on-surface-variant uppercase tracking-widest">≈
										$5,525.00</div>
								</div>
								<div className="flex gap-2">
				...
				<div className="lg:col-span-4 space-y-8">
					...
					<div className="bg-surface-container-low rounded-xl overflow-hidden aspect-video relative group">
						...
						<div className="absolute bottom-4 left-4 z-20">
							<p className="text-[10px] font-label uppercase tracking-widest text-primary font-bold">Meta-Address</p>
							<p className="text-xs text-on-surface">st:eth:0x03312...b1660331...b166</p>
						</div>
					</div>
				</div>
			</section>
